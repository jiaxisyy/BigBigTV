...
/**
 * Created by ChenGD on 2017-4-11.
 */
...
public class RecyclerViewItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public RecyclerViewItemDecoration(int space, int color) {
        this.space = space;
        this.color = color;
    ...
    public RecyclerViewItemDecoration(int space, int color, int type) {
        this.space = space;
        this.color = color;
        mPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mPaint.setColor(color);
    ...
    public RecyclerViewItemDecoration(int space, Drawable mDivider) {
        this.space = space;
